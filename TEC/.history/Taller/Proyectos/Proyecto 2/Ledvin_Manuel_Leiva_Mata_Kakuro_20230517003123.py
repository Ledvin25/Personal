...
playBtn = tk.Button(root, text="Jugar", borderwidth=0, relief=tk.SOLID, bg=root["background"], highlightthickness=0, highlightbackground=root["background"])
...
playBtn.config(borderwidth=0, relief=tk.SOLID, highlightthickness=1, highlightbackground="#000000")
