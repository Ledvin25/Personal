...
def play():
    ...
    playWindow.geometry(f"1280x720+{playWindow.winfo_screenwidth()//2-640}+{playWindow.winfo_screenheight()//2-360}")
    playWindow.maxsize(width=1280, height=720)
    playWindow.minsize(width=1280, height=720)

    # Titulo
    KakuroText = tk.Label(playWindow, text="Kakuro", font=("Eras Bold ITC", 50))
