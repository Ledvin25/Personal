...
def play():
    ...
    playerNameLabel = tk.Label(playWindow, text="Nombre del jugador:", font=("Eras Bold ITC", 12))
    playerName = tk.Entry(playWindow, placeholder="Escribe aquí",  width=20, font=("Eras Bold ITC", 12))
