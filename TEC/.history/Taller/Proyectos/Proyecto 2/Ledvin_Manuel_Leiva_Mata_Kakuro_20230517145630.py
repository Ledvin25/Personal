...
def play():
    ...
    # Posicionamiento
    KakuroText.grid(row=0, column=0, columnspan=2, padx=30)
    playerNameLabel.grid(row=0, column=2)
    playerName.grid(row=0, column=3, columnspan=2)
    Tablero.grid(row=1, column=0, columnspan=10, )
    ...
    # Iniciar
    iniciar = tk.Button(playWindow, text="INICIAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    iniciar.grid(row=2, column=0, columnspan=2, padx=30, pady=25)

    # Deshacer y Rehacer
    deshacer = tk.Button(playWindow, text="DESHACER", width=15, height=2, font=("Eras Demi ITC", 12))
    deshacer.grid(row=2, column=2, columnspan=2, padx=30, pady=25)
    rehacer = tk.Button(playWindow, text="REHACER", width=15, height=2, font=("Eras Demi ITC", 12))
    rehacer.grid(row=3, column=4, columnspan=2, padx=30, pady=25)

    # Borrar casilla, Borrar juego y terminar juego

    borrarCasilla = tk.Button(playWindow, text="BORRAR CASILLA", width=15, height=2, font=("Eras Demi ITC", 12))
    borrarCasilla.grid(row=2, column=0, columnspan=2, padx=30, pady=25)
    borrarJuego = tk.Button(playWindow, text="BORRAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    borrarJuego.grid(row=3, column=2, columnspan=2, padx=30, pady=25)
    terminarJuego = tk.Button(playWindow, text="TERMINAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    terminarJuego.grid(row=4, column=4, columnspan=2, padx=30, pady=25)

    # Top 10, guardar juego y cargar juego

    top10 = tk.Button(playWindow, text="TOP 10", width=15, height=2, font=("Eras Demi ITC", 12))
    top10.grid(row=4, column=0, columnspan=2, padx=30, pady=25)
    guardarJuego = tk.Button(playWindow, text="GUARDAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    guardarJuego.grid(row=4, column=2, columnspan=2, padx=30, pady=25)
    cargarJuego = tk.Button(playWindow, text="CARGAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    cargarJuego.grid(row=4, column=4, columnspan=2, padx=30, pady=25)
