...
def play():
    ...
    guardarJuego.grid(row=2, column=3, padx=30, pady=25)
    cargarJuego = tk.Button(playWindow, text="CARGAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12))
    cargarJuego.grid(row=3, column=3, padx=30, pady=25)
    ...
    horasTexto.grid(row=2, column=0, padx=10, pady=10)
    ...
    minutos.grid(row=0, column=1, padx=10, pady=10)

    # Segundos
    segundos = tk.Label(Contador, text="00", font=("Eras Demi ITC", 12))
    segundos.grid(row=0, column=2, padx=10, pady=10)
