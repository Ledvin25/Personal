...
def play():
    ...
    # Deshacer y Rehacer
    deshacer = tk.Button(playWindow, text="DESHACER", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    deshacer.grid(row=1, column=1, padx=30, pady=(690,0))
    rehacer = tk.Button(playWindow, text="REHACER", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    rehacer.grid(row=2, column=1, padx=30, pady=25)

    # Borrar casilla, Borrar juego y terminar juego

    borrarCasilla = tk.Button(playWindow, text="BORRAR CASILLA", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    borrarCasilla.grid(row=1, column=2, padx=30, pady=(690,0))
    borrarJuego = tk.Button(playWindow, text="BORRAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    borrarJuego.grid(row=2, column=2, padx=30)
    terminarJuego = tk.Button(playWindow, text="TERMINAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    terminarJuego.grid(row=3, column=2, padx=30)

    # Top 10, guardar juego y cargar juego

    top10 = tk.Button(playWindow, text="TOP 10", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    top10.grid(row=1, column=3, padx=30, pady=(690,0))
    guardarJuego = tk.Button(playWindow, text="GUARDAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
    guardarJuego.grid(row=2, column=3, padx=30, pady=0)
    cargarJuego = tk.Button(playWindow, text="CARGAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066')
