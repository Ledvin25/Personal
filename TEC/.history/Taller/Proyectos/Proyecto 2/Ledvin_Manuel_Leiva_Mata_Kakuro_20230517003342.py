...
playBtn = tk.Button(root, text="Mi botón", bg=root["background"], highlightthickness=1, highlightbackground=root["background"])
play.Btn.configure(borderwidth=0, highlightthickness=0)
