...
def play():
    ...
    iniciar.grid(row=1, column=0, columnspan=2, padx=30, pady=(690,0))

    # Deshacer y Rehacer
    deshacer = tk.Button(playWindow, text="DESHACER", width=15, height=2, font=("Eras Demi ITC", 12))
    deshacer.grid(row=1, column=1, columnspan=2, padx=30, pady=(690,0))
    rehacer = tk.Button(playWindow, text="REHACER", width=15, height=2, font=("Eras Demi ITC", 12))
    rehacer.grid(row=2, column=1, columnspan=2, padx=30, pady=25)
