...
def pedidos_totales(lista):
    ...
    for codigo_tableta in lista[0]:
        for codigo_tableta2 in lista[0]:
            if codigo_tableta == codigo_tableta2:
                if codigo_tableta not in pedidos:
                    pedidos[codigo_tableta] = lista[0][codigo_tableta] + lista[1][codigo_tableta2]
