...
def lugares_de_votacion():
    electores = { 1234567: ['José', 'Cartago Escuela Buenaventura', 2000], 456712: ['Carmen', 'Turrialba Colegio Central', 1700], 1234444: ['Alberto', 'Cartago Colegio SLG', 3002], 1111111: ['Olga', 'Cartago Colegio SLG', 3002], 1234555: ['Emilia', 'Cartago Colegio SLG', 3010],
