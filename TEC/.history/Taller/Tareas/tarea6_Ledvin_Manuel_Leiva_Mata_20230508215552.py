    ...
    for numero in lista:
        if numero not in diccionario:
            for i, numero2 in enumerate(lista):
                if numero2 not in diccionario:
                    if numero == numero2: # Si el numero es igual al numero2 se agrega al diccionario
                        diccionario[numero] = (i,)
                else: # Si el numero2 ya esta en el diccionario se agrega al diccionario
                    diccionario[numero] += (i,)
