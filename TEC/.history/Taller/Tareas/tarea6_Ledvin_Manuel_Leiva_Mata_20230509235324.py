...
def produce(produccion, porcentaje):
    ...
    for tipo_llantas in produccion:q
        for i, modelo_llantas in enumerate(tipo_llantas):
            defectuosas.append(int(modelo_llantas * (porcentaje[i]/100)))
            perfectas.append(modelo_llantas - defectuosas[i])
        


produce([ [2000, 2500, 3000],
            [2500, 3500, 4000] ],
                                [ 5, 4, 2] )
