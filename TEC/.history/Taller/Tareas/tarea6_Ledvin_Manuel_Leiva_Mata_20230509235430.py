...
def produce(produccion, porcentaje):
    ...
    for tipo_llantas in produccion:
        for i, cantidad_llantas in enumerate(tipo_llantas):
            defectuosas.append(int(cantidad_llantas * (porcentaje[i]/100)))
            perfectas.append(cantidad_llantas - defectuosas[i])
