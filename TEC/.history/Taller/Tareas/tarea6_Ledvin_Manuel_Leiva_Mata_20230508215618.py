    ...
    for numero in lista:
        if numero not in diccionario:
            for i, numero2 in enumerate(lista):
                if numero2 not in diccionario: # si el numero no esta en el diccionario se agrega con su indice
                    if numero == numero2:
                        diccionario[numero] = (i,)
                else: # si el numero ya esta en el diccionario se agrega el indice
                    diccionario[numero] += (i,)
