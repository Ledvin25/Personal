...
def ordernar_marcas():
    ...
    # crear lista con codigo de prueba de primer elemento y mas listas con las marcas de los atletas, nombre del atleta, su posicion y su dorsal

    lista_pruebas = []

    for elemento in lista_final:
        for elemento1 in elemento[1:]:
            lista_pruebas.append([elemento1[0]])
            for elemento2 in elemento1[1:]:
                lista_pruebas.append([elemento2[2], elemento2[0], elemento2[1]])

    # ordenar lista_pruebas de mayor a menor si tipo_medicion == 'M' o de menor a mayor si tipo_medicion == 'T'
    ...
    # ordenar marcas de mayor a menor si tipo_medicion == 'M' o de menor a mayor si tipo_medicion == 'T'
