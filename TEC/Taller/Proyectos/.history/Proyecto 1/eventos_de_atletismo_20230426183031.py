    ...
    # Marcas de todos los eventos
        ...
        for elemento in marcas_por_evento:
            ...
            for elemento2 in elemento[1:]:
                for elemento3 in pruebas:
                    if elemento2[0] == elemento3[0]:
                        pdf.drawString(80, yspace_evento, 'Prueba:' + ' ' + str(elemento2[0]))
                        pdf.drawString(220, yspace_evento, elemento3[1])
                        pdf.drawString(360, yspace_evento, 'Categoria: ' + ' ' + elemento3[2])
                        pdf.drawString(500, yspace_evento, 'Sexo:' + ' ' + elemento3[3])
                        break
