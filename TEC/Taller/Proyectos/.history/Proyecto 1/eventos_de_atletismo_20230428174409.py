                ...
                if id_evento[0] == elemento[0]:
                    for prueba in pruebas:
                        if prueba[0] == elemento[1]:
                            ...
                            pdf.drawString(50, yspace_prueba - 15, 'Nombre del evento')
                            pdf.drawString(190, yspace_prueba - 15, 'Marca')
                            pdf.drawString(330, yspace_prueba - 15, 'Posicion')
                                    ...
                                    for id_prueba in marca[1:]:
                                        if id_prueba[0] == elemento[1]:
                                            for elemento2 in id_prueba[1:]:
                                                if elemento2[1] == nombre:
                                                    yspace_prueba -= 15
                                                    pdf.drawString(50, yspace_prueba, elemento2[2])
                                                    pdf.drawString(190, yspace_prueba, str(dar_formato_marca(elemento2[0], tipo_medicion(elemento[1]))))
                                                    pdf.drawString(330, yspace_prueba, str(elemento2[3]))
                                
                            

                            

                            yspace_marca = yspace_prueba - 30
