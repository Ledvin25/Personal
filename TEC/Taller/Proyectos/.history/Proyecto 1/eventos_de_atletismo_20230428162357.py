                ...
                for elemento3 in elemento2[1:]:
                    if nombre == elemento3[1]:
                        ...
                        for nombre_evento in eventos:
                            if elemento[0] == nombre_evento[0]:
                                pdf.drawString(80, yspace_evento, 'Evento:' + ' #' + nombre_evento[1])
                                

                            # agregar texto para marca y posicion al nivel del nombre del evento

                            pdf.drawString(80, yspace_evento-30, 'Marca')
                            pdf.drawString(220, yspace_evento-30, 'Posicion en el evento')

                            # agregar al pdf las marcas y posiciones del atleta

                            for elemento5 in elemento2[1:]:
                                if nombre == elemento5[1]:
                                    pdf.drawString(80, yspace_evento-45, str(dar_formato_marca(elemento5[0], tipo_medicion(elemento2[0]))))
                                    pdf.drawString(220, yspace_evento-45, str(elemento5[3]))

                            yspace_evento = yspace_evento - 60
