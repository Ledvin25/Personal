...
def marcas_por_atleta():
    ...
    opcion = 2#int(input('Ingrese una opcion: '))
    ...
    if opcion == 1:
        ...
        identificacion = '3123456789'#input('Ingrese la identificacion del atleta: ')
    ...
    # Marcas de todos los atletas
        ...
        pdf.drawString(50, 800, "APLICACIÓN EVENTOS DE ATLETISMO")
        pdf.drawString(50, 785, "MARCAS POR ATLETA")
        pdf.drawString(50, 770, "MARCAS DE TODOS LOS ATLETAS")

        # agregar al pdf agrupados por atleta los eventos en los que participo el atleta
        ...
        for elemento in marcas:
            for elemento2 in elemento[1:]:
                for elemento3 in elemento2[1:]:
                    yspace_atleta -= 15
                    pdf.drawString(50, yspace_atleta, elemento3[1])
                    pdf.drawString(190, yspace_atleta, elemento2[0])
                    pdf.drawString(330, yspace_atleta, elemento[0])
                    pdf.drawString(470, yspace_atleta, str(dar_formato_marca(elemento3[0], tipo_medicion(elemento2[0]))))
