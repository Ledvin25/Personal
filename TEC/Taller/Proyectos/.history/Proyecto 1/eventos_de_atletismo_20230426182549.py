    ...
    # Marcas de todos los eventos
        ...
        for elemento in marcas_por_evento:
            ...
            for elemento2 in elemento[1:]:
                for elemento3 in pruebas:
                    if elemento2[0] == elemento3[0]:
                        pdf.drawString(80, yspace_evento - 15, 'Prueba:' + ' ' + str(elemento2[0]))
                        pdf.drawString(220, yspace_evento - 15, elemento3[1])
                        pdf.drawString(360, yspace_evento - 15, 'Categoria: ' + ' ' + elemento3[2])
                        pdf.drawString(500, yspace_evento - 15, 'Sexo:' + ' ' + elemento3[3])
                        break
                ...
                for elemento4 in elemento2[1:]:
                    yspace_atleta -= 15
                    pdf.drawString(80, yspace_atleta, str(elemento4[1]))
                    pdf.drawString(220, yspace_atleta, str(elemento4[2]))
                    pdf.drawString(360, yspace_atleta, str(dar_formato_marca(elemento4[0], tipo_medicion(elemento2[0]))))

                yspace_evento = yspace_atleta - 30
