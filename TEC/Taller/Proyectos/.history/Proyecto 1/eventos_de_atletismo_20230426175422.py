...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            for elemento4 in datos_finales[2:]:
                pdf.drawString(80, yspace, 'Prueba:' + ' ' + str(elemento4[0]))
                pdf.drawString(190, yspace, elemento4[1])
                pdf.drawString(80, yspace, 'Categoria:' + ' ' + str(elemento4[2]))
                pdf.drawString(190, yspace, elemento4[3])
