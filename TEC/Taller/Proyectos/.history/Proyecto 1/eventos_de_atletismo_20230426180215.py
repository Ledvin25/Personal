...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            for elemento4 in datos_finales[2:]:
                ...
                pdf.drawString(360, yspace_prueba, str(elemento4[2]))
                pdf.drawString(500, yspace_prueba, elemento4[3])
                ...
                pdf.drawString(190, yspace_atleta, 'Dorsal')
                pdf.drawString(300, yspace_atleta, 'Marca')
                pdf.drawString(410, yspace_atleta, 'Lugar')
