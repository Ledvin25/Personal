...
def mejores_marcas_por_prueba():
    ...
    # encontrar pruebas dentro del rango de fechas y agregarlas a la lista datos_finales: la identificacion del evento, el nombre del evento y el codigo de las pruebas en las que participo
