        ...
        for fecha_evento in eventos:
            if elemento[0] == fecha_evento[0] and validar_rango_fechas(fecha_evento[4], fecha_inicial, fecha_final ):
                ...
                for elemento2 in elemento[1:]:
                    ...
                    pdf.drawString(400, yspace_atleta, 'Posicion en el evento')
                    pdf.drawString(500, yspace_atleta, 'Nombre del evento')
                                    ...
                                    for elemento5 in id_prueba[1:]:
                                        for pais in atletas:
                                            ...
                                            if elemento5[1] == name:
                                                        ...
                                                        pdf.drawString(500, yspace_atleta, fecha_evento[1])
