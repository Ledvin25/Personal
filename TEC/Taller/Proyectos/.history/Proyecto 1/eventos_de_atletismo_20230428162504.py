...
def marcas_por_atleta():
    ...
    if opcion == 1:
        ...
        pdf = canvas.Canvas("C:/Users/led_2/Desktop/mi_pdf.pdf")
        pdf.drawString(80, 800, "APLICACIÓN EVENTOS DE ATLETISMO")
        pdf.drawString(80, 785, "MARCAS POR ATLETA")
        pdf.drawString(80, 770, "MARCAS DE UN ATLETA ESPECIFICO")

        # solicitar identificacion del atleta

        identificacion = '2023071280'#(input('Ingrese la identificacion del atleta: ')

        # encontrar nombre del atleta
        ...
        for elemento in marcas:
            for elemento2 in elemento[1:]:
                for elemento3 in elemento2[1:]:
                    if nombre == elemento3[1]:
                        pdf.drawString(80, yspace_atleta, 'Atleta:' + ' ' + nombre)

                        

                        yspace_prueba = yspace_atleta - 15

                        # agregar al pdf el nombre de la prueba, categoria y sexo

                        for elemento4 in pruebas:
                            if elemento4[0] == elemento2[0]:
                                pdf.drawString(80, yspace_prueba, 'Prueba:' + ' ' + str(elemento2[0]))
                                pdf.drawString(220, yspace_prueba, elemento4[1])
                                pdf.drawString(360, yspace_prueba, 'Categoria: ' + ' ' + elemento4[2])
                                pdf.drawString(500, yspace_prueba, 'Sexo:' + ' ' + elemento4[3])
                        ...
                        # agregar al pdf el nombre del evento

                        yspace_evento = yspace_prueba - 15

                        for elemento5 in eventos:
                            if elemento5[0] == elemento[0]:
                                pdf.drawString(80, yspace_evento, 'Evento:' + ' #' + str(elemento[0]))
                                pdf.drawString(220, yspace_evento, elemento5[1])
                                break

                        # agregar al pdf las marcas del atleta

                        yspace_marca = yspace_evento - 15

                        pdf.drawString(80, yspace_marca, 'Marca')
                        pdf.drawString(220, yspace_marca, 'Lugar')
                        pdf.drawString(360, yspace_marca, 'Fecha')

                        for elemento6 in elemento2[1:]:
                            if nombre == elemento6[1]:
                                yspace_marca -= 15
                                pdf.drawString(80, yspace_marca, str(dar_formato_marca(elemento6[0], tipo_medicion(elemento2[0]))))
                                pdf.drawString(220, yspace_marca, str(elemento6[3]))
                                pdf.drawString(360, yspace_marca, str(elemento6[4]))

                        yspace_atleta = yspace_marca - 30

                        yspace_prueba = yspace_marca - 60

                        yspace_evento = yspace_marca - 90
