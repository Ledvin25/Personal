...
def mejores_marcas_por_prueba():
    ...
    pdf.drawString(50, 800, "APLICACIÓN EVENTOS DE ATLETISMO")
    pdf.drawString(50, 785, "MARCAS POR EVENTO")
    pdf.drawString(50, 770, "MARCAS DE TODOS LOS EVENTOS")
    ...
    for elemento01 in marcas_por_evento:
        for fecha_evento in eventos:
            if elemento01[0] == fecha_evento[0] and validar_rango_fechas(fecha_evento[4], fecha_inicial, fecha_final ):
                pdf.drawString(50, yspace_evento, 'Evento:' + ' #' + str(elemento01[0]))
                pdf.drawString(190, yspace_evento, fecha_evento[1])
                ...
                for elemento2 in elemento01[1:]:
                    ...
                    pdf.drawString(330, yspace_atleta, 'Marca')
                    pdf.drawString(470, yspace_atleta, 'Posicion en el evento')
                    pdf.drawString(550, yspace_atleta, 'Nombre del evento')

                    for id_evento in marcas:
                        if elemento01[0] == id_evento[0]:
                            for id_prueba in id_evento[1:]:
                                if elemento2[0] == id_prueba[0]:
                                    for elemento5 in id_prueba[1:]:
                                        for pais in atletas:
                                            ...
                                            if elemento5[1] == name:
                                                        ...
                                                        pdf.drawString(330, yspace_atleta, str(dar_formato_marca(elemento5[0], tipo_medicion(elemento2[0]))))
                                                        pdf.drawString(470, yspace_atleta, str(elemento5[3]))
                                                        pdf.drawString(550, yspace_atleta, elemento[2])
