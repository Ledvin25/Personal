...
def validar_correo_electronico(correo_electronico):
    ...
    if domain == 'hotmail.com' or domain == 'yahoo.com' or domain == 'outlook.com': # si el dominio pertenece a outlook devolver true automaticamente, ya que el EULA no permite comprobar su existencia.
        return True 
