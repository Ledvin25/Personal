...
# 1.1 Agregar disciplinas
    ...
    while nombre not in lista_disciplinas:
        print('La disciplina no existe')
        nombre = input('Ingrese el nombre de la disciplina: ')
        if nombre == 'C':
            registrar_disciplinas()

    # Si la disciplina existe se muestran los datos de la misma

    # Opcion aceptar 'A' y volver a llamar a la funcion Opcion, 'C' y salir al menu anterior
