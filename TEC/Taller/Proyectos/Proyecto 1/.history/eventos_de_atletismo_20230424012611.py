...
def consultar_marcas():
    ...
    while verify:
        ...
        for elemento1 in pruebas:
            ...
            codigo = ('Ingrese el codigo de la prueba: ')
    ...
    for elemento3 in marcas_por_evento:
        if not identificacion == elemento3[0] and codigo == elemento3[1]:
            for elemento4 in elemento3[2:]:
                if identificacion_atleta == elemento4[0]:
