...
def validar_correo_electronico(correo_electronico):
    ...
    from validate_email_address import validate_email # Verificar que el correo electronico sea un string con formato de correo electronico
    isvalid = validate_email(correo_electronico)
    
    isexist = validate_email(correo_electronico, verify=True)
    print(isexist)
