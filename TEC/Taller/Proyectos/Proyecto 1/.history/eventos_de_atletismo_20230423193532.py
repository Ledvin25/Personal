...
def agregar_atletas():
    ...
    if validar_identificacion(identificacion) == True:
        nombre = input('Ingrese el nombre del atleta: ')
        if validar_nombre(nombre) == True:
            apellido = input('Ingrese el apellido del atleta: ')
            if validar_apellido(apellido) == True:
                pais = input('Ingrese el pais del atleta: ')
                if validar_pais(pais) == True:
                    fecha_nacimiento = input('Ingrese la fecha de nacimiento del atleta (dd/mm/aaaa): ')
                    if validar_fecha_nacimiento(fecha_nacimiento) == True:
                        correo_electronico = input('Ingrese el correo electronico del atleta: ')
                        if validar_correo_electronico(correo_electronico) == True:
                            telefono = input('Ingrese el telefono del atleta: ')
                            if validar_telefono(telefono) == True:
                                atleta = [identificacion, nombre, apellido, pais, fecha_nacimiento, correo_electronico, telefono]
