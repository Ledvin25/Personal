...
api_key = 'HE6t5Xcu.JH9hcgsS8fO6VcfmtKz2Y5Jmq9wqZYlG'

email_address = 'led_25.ok@hotmail.es'

response = requests.get('https://isitarealemail.com/api/email/validate', params={'email': email_address}, headers=)
