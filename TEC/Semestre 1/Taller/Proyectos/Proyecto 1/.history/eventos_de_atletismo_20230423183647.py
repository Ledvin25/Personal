...
def validar_identificacion(identificacion):
    ...
    if type(identificacion) == str and len(identificacion) >= 9 and len(identificacion) <= 20: # Verificar que la identificacion sea un string y que tenga entre 9 y 20 caracteres
