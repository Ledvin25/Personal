...
def validar_correo_electronico(correo_electronico):
    ...
    is_valid = validate_email(email_address=correo_electronico, check_regex=True, check_mx=True, from_address='ledvin25@from.addr.ess', helo_host='my.host.name', smtp_timeout=10, dns_timeout=10, use_blacklist=True, debug=False)
    print(is_valid)
