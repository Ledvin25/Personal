...
atletas = [ ['3123456789', 'Pedro', 'Pérez', 'Peraza', 'M', 'CRI', 15\102000, 'pedropp@gmail.com', 55556789 ] ]

eventos = [[25, 'I Campeonato Centroamericano de atletismo', 'CRI', 'Parque La Sabana Costa Rica', 10012023, 12012023]]
...
def agregar_marcas():
    ...
    identificacion_atleta = int(input('Ingrese la identificacion del atleta: '))
    ...
    while verify:
        for elemento in atletas:
            if identificacion_atleta == elemento[0]:
                verify = False
        if identificacion_atleta == 'C' or identificacion_atleta == 'c':
            os.system('cls')
            registrar_marcas()
        else:
