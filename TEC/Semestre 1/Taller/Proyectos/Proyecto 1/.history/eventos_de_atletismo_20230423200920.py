...
def validar_fecha_evento(fecha_inicial, fecha_final):
    ...
    try:
        datetime.datetime.strptime(fecha_final, '%d/%m/%Y') # Verificar que la fecha de nacimiento sea un string con formato 'dd/mm/aaaa'
        datetime.datetime.strptime(fecha_inicial, '%d/%m/%Y') # Verificar que la fecha de nacimiento sea un string con formato 'dd/mm/aaaa'
        return True
    except ValueError:
        return False
