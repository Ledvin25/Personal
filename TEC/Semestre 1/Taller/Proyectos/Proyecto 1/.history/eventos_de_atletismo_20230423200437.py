...
def agregar_eventos():
    ...
    # solicitar codigo del evento

    codigo = input('Ingrese el codigo del evento: ')
    ...
    while not validar_lugar(lugar):
        print('LUGAR INVALIDO')
        lugar = input('Ingrese el lugar del evento: ')

    # solicitar disciplina del evento

    disciplina = input('Ingrese la disciplina del evento: ')

    while not validar_disciplina(disciplina):
        print('DISCIPLINA INVALIDA')
        disciplina = input('Ingrese la disciplina del evento: ')

    # solicitar numero de participantes

    participantes = input('Ingrese el numero de participantes: ')

    while not validar_participantes(participantes):
        print('NUMERO DE PARTICIPANTES INVALIDO')
        participantes = input('Ingrese el numero de participantes: ')

    # solicitar atletas participantes

    atletas_participantes = input('Ingrese los atletas participantes: ')

    while not validar_atletas_participantes(atletas_participantes):
        print('ATLETAS PARTICIPANTES INVALIDOS')
        atletas_participantes = input('Ingrese los atletas participantes: ')

    # solicitar duracion del evento

    duracion = input('Ingrese la duracion del
