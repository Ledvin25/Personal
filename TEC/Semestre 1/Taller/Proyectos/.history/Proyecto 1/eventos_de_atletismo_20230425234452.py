...
# Establecer orden de marcas por evento y el atleta que las realizo
...
def marcas_por_evento_datos():
    ...
    while verify:
        ...
        for elemento in marcas_por_evento:
            ...
            print('EVENTO NO ESTA REGISTRADO, NO SE PUEDE ANALIZAR')
            identificacion = int(input('Ingrese la identificacion del evento: '))
    ...
    while verify:
        ...
        for elemento1 in elemento[1:]:
            ...
            print('CODIGO NO ESTA REGISTRADO, NO SE PUEDE ANALIZAR')
            codigo = input('Ingrese el codigo de la prueba: ')
    ...
    # ordenar marcas de mayor a menor

    marcas_ordenadas = sorted(elemento1[1:], key=lambda x: x[2], reverse=True)

    # imprimir marcas

    for elemento2 in marcas_ordenadas:
