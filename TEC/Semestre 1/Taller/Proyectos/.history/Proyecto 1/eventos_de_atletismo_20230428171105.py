...
def marcas_por_atleta():
    ...
    if opcion == 1:
        ...
        # buscar los eventos en los que participo el atleta y agregarlos a la lista datos_finales: la identificacion del evento, el nombre del evento y el codigo de las pruebas 
