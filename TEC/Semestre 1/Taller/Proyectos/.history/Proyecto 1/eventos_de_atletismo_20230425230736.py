...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            for elemento2 in marcas_por_evento_listas:
                if elemento2[0] == identificacion:
                    for elemento3 in pruebas:
                        if elemento3[0] == elemento2[1]:
                            datos_finales.append(elemento2[1])
                            datos_finales.append(elemento3[1])
                            for elemento4 in disciplinas:
                                if elemento4[0] == elemento3[4]:
                                    datos_finales.append(elemento4[1])
                                    break
                            break
                    break
