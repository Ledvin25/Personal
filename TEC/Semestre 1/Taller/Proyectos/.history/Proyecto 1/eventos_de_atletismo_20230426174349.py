...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            pdf.drawString(100, 800, "APLICACIÓN EVENTOS DE ATLETISMO")
            pdf.drawString(100, 750, "MARCAS POR EVENTO")
            pdf.drawString(100, 700, "EVENTO ESPECIFICO")
            ...
            pdf.drawString(70, 650, str(datos_finales[0]))
            pdf.drawString(210, 650, datos_finales[1])
            ...
            for elemento4 in datos_finales[2:]:
                pdf.drawString(100, 240, str(elemento4[0]))
                pdf.drawString(100, 260, elemento4[1])
                pdf.drawString(100, 280, elemento4[2])
                pdf.drawString(100, 300, elemento4[3])'''
