...
import DNS # Libreria para validar el correo electronico
...
def validar_correo_electronico(correo_electronico):
    ...
    if isvalid:
        ...
        try:
            MX_record = DNS.mxlookup(domain) # Verificar que el dominio del correo electronico exista
            if len(MX_record) > 0:
                print('La direccion de correo electronico ' + correo_electronico + ' es valida y existe en el dominio ' + domain)	
