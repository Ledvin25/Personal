...
330
470
550 yspace_atleta, elemento5[1])
                                                pdf.drawString(50,
190
330
470
550, yspace_atleta, pais[5])
                                                pdf.drawString(50,
190
330
470
550, yspace_atleta, str(dar_formato_marca(elemento5[0], tipo_medicion(elemento2[0]))))
                                                pdf.drawString(50,
190
330
470
550, yspace_atleta, str(elemento5[3]))
