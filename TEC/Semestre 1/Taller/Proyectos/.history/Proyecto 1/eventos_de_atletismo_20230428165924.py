...
def marcas_por_atleta():
    ...
    if opcion == 1:
        ...
        # Crear un lienzo
            ...
            # verificar que la identificacion del atleta exista

            verify = True

            while verify:
                # buscar el atleta en la lista de atletas y guardar nombre y apellidos
                for elemento in atletas:
                ...
                if verify:
                    identificacion = input('Identificacion no encontrada, ingrese una identificacion valida: ')
                    input('Ingrese la identificacion del atleta: ')

            # encontrar pruebas en las que participo el atleta

            for elemento in marcas:
                for elemento2 in elemento[1:]:
                    for elemento3 in elemento2[1:]:
                        if elemento3[1] == nombre:
                            eventos_participados.append([elemento[0],[elemento2[0], elemento3]])

            # agregar al pdf el nombre del atleta

            pdf.drawString(80, 740, 'Atleta:' + nombre)

            # encontrar prueba, nombre de la prueba, categoria y sexo

            for elemento2 in eventos_participados[1:]:
                for elemento3 in elemento2[1:]:
                    for elemento4 in pruebas:
                        if elemento4[0] == elemento3[0]:
                            datos_finales.append([elemento4[0], elemento4[1], elemento4[2], elemento3[3]])
                            break
