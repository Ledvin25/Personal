...
def ordernar_marcas():
    ...
    # crear lista de listas con las marcas de cada atleta por evento y por prueba con su respectivo codigo y el nombre del atleta y su dorsal

    marcas_por_evento = []

    for elemento in eventos:
        marcas_por_evento.append([elemento[0]])
