...
def mejores_marcas_por_prueba():
    ...
    while verify:
        ...
        # verificar que la fecha de inicio sea valida

        try:
            datetime.datetime.strptime(fecha_inicio, '%d/%m/%Y')
            verify = False
        except:
            fecha_inicio = input('Fecha de inicio invalida, ingrese una fecha valida (dd/mm/aaaa): ')

    verify = True

    while verify:

        # verificar que la fecha de fin sea valida

        try:
            datetime.datetime.strptime(fecha_fin, '%d/%m/%Y')
            verify = False
        except:
            fecha_fin = input('Fecha de fin invalida, ingrese una fecha valida (dd/mm/aaaa): ')
