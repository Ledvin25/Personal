...
atletas = [ ['3123456789', 'Pedro', 'Pérez', 'Peraza', 'M', 'CRI', '15/10/2000', 'pedropp@gmail.com', '55556789' ], ['3023456789', 'Juan', 'Pérez', 'Peraza', 'M', 'CRI', '15/10/2000', 'juanp@gmail.com', '55556789' ], ['3023456789', 'Ledvin', 'Leiva', 'Mata', 'M', 'CRI', '25/12/2004', 'ledvin25@hotmail.com', '55556789' ]]
    ...
    for elemento in lista_final:
        for elemento1 in elemento[1:]:
            if tipo_medicion(elemento1[0]) == 'T':
                elemento1[1:] = sorted(elemento1[1:], key = lambda x: x[0])
            elif tipo_medicion(elemento1[0]) == 'M':
                elemento1[1:] = sorted(elemento1[1:], key = lambda x: x[0], reverse = True)
