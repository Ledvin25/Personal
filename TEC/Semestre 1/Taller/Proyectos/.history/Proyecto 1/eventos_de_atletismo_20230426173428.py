...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            # agregar al pdf encabezado con evento y nombre

            pdf.drawString(100, 200, identificacion)
            pdf.drawString(300, 200, nombre_evento)
            ...
            # agregar al pdf tabla con prueba, nombre de la prueba, categoria y sexo

            pdf.drawString(100, 200, datos_finales[1][0])
