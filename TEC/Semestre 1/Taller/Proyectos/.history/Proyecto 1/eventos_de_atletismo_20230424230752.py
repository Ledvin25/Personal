...
def agregar_marcas():
    ...
    verify = True
    for elemento1 in marcas_por_evento:
        if identificacion_evento == elemento1[0]:
            verify = False
            break
    else:
        if verify:
            marcas_por_evento.append([identificacion_evento])
            elemento1 = marcas_por_evento[marcas_por_evento.index([identificacion_evento])]
