                ...
                if id_evento[0] == elemento[0]:
                    for prueba in pruebas:
                        if prueba[0] == elemento[1]:
                            ...
                            pdf.drawString(220, yspace_prueba, 'Prueba: ' + prueba[0])
                            pdf.drawString(360, yspace_prueba, prueba[1])
                            pdf.drawString(500, yspace_prueba, 'Categoria: ' + prueba[2])
                            pdf.drawString(640, yspace_prueba, 'Sexo: ' + prueba[3])
