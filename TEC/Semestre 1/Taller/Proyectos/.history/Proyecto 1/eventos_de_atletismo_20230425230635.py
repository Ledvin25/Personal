...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            for element in marcas_por_evento:
                marcas_por_evento_listas.append(element[0])
                for elemento1 in element[1:]:
                    marcas_temporales = []
                    marcas_temporales.append(element1[0])
                    for elemento2 in element1[1:]:
