    ...
    if opcion == 1:
            ...
            for elemento4 in datos_finales[2:]:
                ...
                for id_evento in marcas:
                    if identificacion == id_evento:
                        for id_prueba in id_evento[1:]:
                            if elemento4[0] == id_prueba[0]:
                                for elemento5 in id_prueba[1:]:
                                    for elemento6 in atletas:
                                        if elemento5[0] == elemento6[0]:
                                            yspace_atleta -= 15
                                            pdf.drawString(80, yspace_atleta, ' '.join([elemento6[1], elemento6[2], elemento6[3]]))
                                            pdf.drawString(220, yspace_atleta, str(elemento5[1]))
                                            pdf.drawString(360, yspace_atleta, str(elemento5[2]))
