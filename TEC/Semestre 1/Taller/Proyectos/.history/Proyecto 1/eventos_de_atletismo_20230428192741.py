...
from email.utils import COMMASPACE # Libreria para enviar correos electronicos
...
def enviar_correo():
        ...
        smtp_port = 587
        smtp_user = 'testledvin25@gmail.com'
        smtp_password = 'Ledma1225'


        # Correo electrónico destino
        correo_destino = 'amataled25@gmail.com'

        # Creación del mensaje de correo electrónico
        msg = MIMEMultipart()
        msg['From'] = smtp_user
        msg['To'] = correo_destino
        msg['Subject'] = 'Resultados de la competencia'

        marcas_por_altleta_correo(identificacion)

        # Adjuntar el archivo PDF
        pdf_file = ruta_escritorio + '/marcas_por_atleta.pdf'
        with open(pdf_file, 'rb') as f:
            pdf_data = f.read()
        pdf = MIMEBase('application', 'pdf')
        pdf.set_payload(pdf_data)
        encoders.encode_base64(pdf)
        pdf.add_header('Content-Disposition', 'attachment', filename='archivo.pdf')
        msg.attach(pdf)
        ...
        smtp.sendmail(smtp_user, correo_destino, msg.as_string())
        smtp.quit()
