...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            # Crear un lienzo
            pdf = canvas.Canvas(ruta_escritorio + '/marcas_por_evento.pdf', pagesize=A4)
    ...
    # Marcas de todos los eventos dentro de un rango de fechas
        ...
        # Crear un lienzo
        pdf = canvas.Canvas("Export/marcas_por_evento.pdf")
        pdf.drawString(80, 800, "APLICACIÓN EVENTOS DE ATLETISMO")
        pdf.drawString(80, 785, "MARCAS POR EVENTO")
...
def marcas_por_atleta():
    ...
    if opcion == 1:
        ...
        # Crear un lienzo
        pdf = canvas.Canvas("/Export/marcas_por_atleta.pdf")
