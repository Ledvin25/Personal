...
eventos = [[25, 'I Campeonato Centroamericano de atletismo', 'CRI', 'Parque La Sabana Costa Rica', '10/01/2023', '12/01/2023'], [28, 'I Campeonato Caribeño de atletismo', 'GUA', 'Guatemala', '10/02/2023', '12/03/2023'], [41, 'I Campeonato Sudamericano de atletismo', 'COL', 'Bogota', '10/03/2023', '12/05/2023']
...
def marcas_por_evento_datos():
    ...
    # Marcas de todos los eventos dentro de un rango de fechas
        ...
        fecha_inicial = '08/01/2023'#int(input('Ingrese la fecha inicial "dd/mm/aaaa": '))
        fecha_final = '12/01/2023'#int(input('Ingrese la fecha final "dd/mm/aaaa": '))
