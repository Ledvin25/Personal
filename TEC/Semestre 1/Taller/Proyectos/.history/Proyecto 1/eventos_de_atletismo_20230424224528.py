...
def eliminar_marcas():
    ...
    codigo = 'V02'#input('Ingrese el codigo de la prueba: ')
    ...
    while True:
        ...
        if opcion == 'A':
            ...
            if confirmacion == 'S':
                ...
                # eliminar datos
                indice1 = marcas_por_evento.index(elemento)
                indice2 = elemento1.index(elemento2)
                elemento1.remove(elemento2)
                elemento[indice2] = elemento1
                marcas_por_evento[indice1] = elemento
                os.system('cls')
