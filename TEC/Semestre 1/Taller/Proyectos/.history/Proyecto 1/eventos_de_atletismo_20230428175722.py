                        ...
                        if prueba[0] == elemento[1]:
                            ...
                            for marca in marcas:
                                if marca[0] == elemento[0]:
                                    for id_prueba in marca[1:]:
                                        if id_prueba[0] == elemento[1]:
                                            if nombre == id_prueba[1]:
                                                for elemento2 in id_prueba[1:]:
                                                    yspace_prueba -= 15
                                                    pdf.drawString(50, yspace_prueba, elemento2[1])
                                                    pdf.drawString(285, yspace_prueba, str(dar_formato_marca(elemento2[0], tipo_medicion(elemento[1]))))
                                                    pdf.drawString(470, yspace_prueba, str(elemento2[3]))
