...
def agregar_marcas():
    ...
    identificacion_evento = 25#int(input('Ingrese la identificacion del evento: '))
    ...
    codigo = 'V01'#input('Ingrese el codigo de la prueba: ')
    ...
    identificacion_atleta = '3123456789'#input('Ingrese la identificacion del atleta: ')
    ...
    dorsal = 25#int(input('Ingrese el dorsal del atleta: '))
    ...
    if tipo_medicion == 'T':
        marca = 2551#int(input('Ingrese la marca del atleta en formato "hhmmsscc": '))
    elif tipo_medicion == 'M':
    ...
    while True:
        ...
        if opcion == 'A' or opcion == 'a':
            os.system('cls')
            elemento5.append([codigo, (identificacion_atleta, dorsal, marca)]
