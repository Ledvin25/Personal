...
disciplinas = [('Carreras de velocidad', 'T'), ('Saltos', 'M'), ('Lanzamientos', 'M'), ('Carreras de saltos', 'T'), ('Carreras de lanzamientos', 'T'), ('Carreras de obstaculos', 'T'), ('Carreras de relevos', 'T'), ('Marcha', 'T'), ('Decatlon', 'T'), ('Heptatlon', 'T'), ('Pentatlon', 'T'), ('Carreras de medio fondo', 'T'), ('Carreras de fondo', 'T'), ('Carreras de vallas')]
...
marcas_por_evento = [[25, ['V02', ('3123456789', 2, 1302),('3023456789', 25, 1201)]], [28, ['S01'], ['V02']], [29, ['V02'], ['S01']]]
...
def marcas_por_evento_datos():
    ...
    if opcion == 1:
            ...
            # ordenar marcas de menor a mayor si el tipo de medicion es 'T' y de mayor a menor si es 'M'

            for elemento4 in elemento[1:]:
                for elemento5 in disciplinas:
                    if elemento5[0] == elemento3[4]:
                        tipo_medicion = elemento5[1]
                        break

                if tipo_medicion == 'T':
                    elemento4[2].sort()
                elif tipo_medicion == 'M':
                    elemento4[2].sort(reverse=True)
