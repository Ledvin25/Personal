                    ...
                    for diagonal_j in range(-1, 2): # recorrer diagonales
                        if diagonal_i != 0 or diagonal_j != 0: 
                            ...
                            for k in range(1, len(word)): # recorrer la palabra
                                ...
                                if filas <= fila < 0 or fila >= filas or columna < 0 or columna >= columnas or lista[fila][columna] != word[k]: # si la palabra no esta en la sopa de letras
                            ...
                            if verify: # si la palabra esta en la sopa de letras
                                tupla.append(tuple(pre_tuple)) # agregar la tupla a la lista de tuplas
