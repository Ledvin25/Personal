...
'''
Esta función recibe una lista de números como entrada y devuelve una lista de números donde los dígitos de los números de la entrada están agrupados y ordenados. La entrada es una lista de números y la función no requiere características adicionales para su entrada. La salida es una lista de números.
