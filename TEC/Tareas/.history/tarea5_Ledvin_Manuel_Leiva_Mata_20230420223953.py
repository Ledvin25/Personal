...
'''
    Esta función recibe una lista como entrada y devuelve una lista de tuplas que representa todas las posibles combinaciones de elementos en la lista original. La entrada es una lista y no tiene características adicionales. La salida es una lista de tuplas que representa todas las posibles combinaciones de elementos en la lista original.
'''
...
def multiplica_matrices(A, B):
    ...
    if len(A[0]) != len(B):
        ...
        matriz_resultante = [[0] * c for _ in range(a)]
