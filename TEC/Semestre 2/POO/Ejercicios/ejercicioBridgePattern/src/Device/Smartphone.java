...
public class Smartphone implements DeviceBridge
{
    private String relacionAspecto;

    public Smartphone() {
        this.relacionAspecto = "9:16";
    }
    ...
    public void reproducirSonido(int volumen) {
        try {
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(Laptop.class.getResource("sound2.wav"));
