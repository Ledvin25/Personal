...
public class TV implements DeviceBridge
{
    private String relacionAspecto;

    public TV () {
        this.relacionAspecto = "14:6";
    }
    ...
    public void reproducirSonido(int volumen) {
        try {
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(Laptop.class.getResource("sound3.wav"));
