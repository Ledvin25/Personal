...
def play():
    ...
    def seleccionarNumero(btn_id):
        ...
        if running:
            ...
            numeroSeleccionado = numero['text']
    ...
    def colocarNumero(btn_id):
        ...
        casilla.config(text=numeroSeleccionado)
    ...
    for i in range(9):
        for j in range(9):
            casilla = tk.Button(Tablero, width=8, height=4, command=lambda num_id=(i,j): colocarNumero(num_id))
