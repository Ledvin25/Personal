...
def settings():
    ...
    horas = tk.Entry(settingsWindow, width=5, font=("Eras Demi ITC", 12), textvariable=str(0))
    minutos = tk.Entry(settingsWindow, width=5, font=("Eras Demi ITC", 12), textvariable=str(0))
    segundos = tk.Entry(settingsWindow, width=5, font=("Eras Demi ITC", 12), textvariable=str(0))
