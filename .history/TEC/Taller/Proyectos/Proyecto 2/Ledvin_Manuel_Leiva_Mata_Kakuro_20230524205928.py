...
def play():
    ...
    def saveGame():
        ...
        # Decodifica las casillas para que el bendito pickle las pueda guardar 
        ...
        # datos a guardar
        saved = [casillas_save, accionesPasadas, accionesFuturas, segundos, minutos, horas, nivel_Casillas]
