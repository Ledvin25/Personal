...
def play():
    ...
    def ventanaConfirmar(text):
        ...
        # Boton de aceptar
        aceptar = tk.Button(confirmWindow, text="SI", font=("Eras Demi ITC", 12), command=confirmar)
        aceptar.pack(pady=10)

        # Boton de cancelar
        cancelar = tk.Button(confirmWindow, text="NO", font=("Eras Demi ITC", 12), command=cancelar)
