...
def play():
    ...
    def borrarJuego():
        ...
        if running:
            ...
            error = tk.Label(Error1, text="EL JUEGO NO HA INICIADO", font=("", 12))
    ...
    playerNameLabel = tk.Label(playWindow, text="Nombre de usuario:", font=("", 12))
    ...
    borrarJuego = tk.Button(playWindow, text="BORRAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#8DB3E2', command=borrarJuego)
