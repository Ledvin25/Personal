...
def play():
    ...
    def gameOver():
            ...
            terminado = tk.Label(gameOver, text="TIEMPO LIMITE FINALIZADO", font=("Eras Demi ITC", 12))
            terminado.pack(pady=10)
    
            # Boton de aceptar
    
            aceptar = tk.Button(gameOver, text="Aceptar", font=("Eras Demi ITC", 12), command=gameOver.destroy)
            aceptar.pack(pady=10)
