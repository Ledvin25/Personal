...
def play():
    ...
    def saveGame():
        ...
        # datos a guardar
        saved = [casillas, accionesPasadas, accionesFuturas, segundos, minutos, horas, nivel_Casillas]
    ...
    guardarJuego = tk.Button(playWindow, text="GUARDAR JUEGO", width=15, height=2, font=("Eras Demi ITC", 12), background='#ED7D31', command=guardarJuego)
