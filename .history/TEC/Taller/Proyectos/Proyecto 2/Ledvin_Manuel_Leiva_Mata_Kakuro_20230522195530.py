...
def play():
    ...
    if nivel_Casillas == ():
        ...
        label = tk.Label(Error1, text="Por favor, escoga un nivel en configuración", font=("Arial", 15))
        label.pack(pady=10)

        # Crear boton

        boton = tk.Button(Error1, text="OK", font=("Arial", 15), command=Error1.destroy)
        boton.pack(pady=10)
