    ...
    def colocarNumero(btn_id):
        ...
        if running:
            ...
            if numero != None:
                ...
                for clave in nivel_Casillas:
                    if clave[2] == btn_id[0] and clave[0] == 2:
                        for i in range(len(clave[4])):
                            if 

                            for i in range(len(casillas[4])):

                                if casillas[(btn_id[0],i)]['text'] == numero['text']:
                                    jugadaNoValida(' EL \nNUMERO YA ESTA EN SU GRUPO DE FILA')
