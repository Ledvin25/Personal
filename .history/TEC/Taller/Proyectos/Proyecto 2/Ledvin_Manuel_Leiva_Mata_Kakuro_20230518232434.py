...
def play():
    ...
    for i in range(9):
        for j in range(9):
            casilla = tk.Button(Tablero, width=8, height=4, command=lambda num_id=(i,j): colocarNumero(num_id), bg="white", font=("Eras Demi ITC", 12))
    ...
    for i in range(1,10):
        numero = tk.Button(numbersWrap, text=i, width=6, height=3, command=lambda num_id=i: seleccionarNumero(num_id), background='white', font=("Eras Demi ITC", 12))
