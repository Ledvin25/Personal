...
def settings():
    ...
    def cargarPartidas():
        ...
        if iDificulty == 1:
            ...
            nivelRandom = random.randrange(0, len(partidas['DIFICIL']))
            nivel_Casillas = partidas['DIFICIL'][nivelRandom]
        elif iDificulty == 4:
    ...
    # botones
    dificultyBtn = tk.Button(settingsWindow, text="DIFICULTAD", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066', command=dificulty)
    ...
    segundos.place(x=300, y=400, anchor="center")
