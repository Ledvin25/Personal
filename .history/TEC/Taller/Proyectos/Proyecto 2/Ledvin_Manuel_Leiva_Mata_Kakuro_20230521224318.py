    ...
    def colocarNumero(btn_id):
        ...
        if running:
            ...
            if numero != None:
                ...
                for i in range(9):
                    try: 
                        print(casillas[(btn_id[0],i)])['text']
                        if casillas[btn_id[0],i] == numero['text'] or casillas[i,btn_id[1]] == numero['text']:
                            
                            jugadaNoValida('EL NUMERO YA ESTA EN SU GRUPO DE FILA O COLUMNA')
