    ...
    def cargarPartidas():
        ...
        partidas = {
                    ...
                    ( # tupla con las partidas del nivel
                            ...
                            ( # tupla con la partida 2 de este nivel
                            ), # fin de la tupla con la partida 2 de este nivel
                        ), # fin de la tupla de partidas de nivel FACIL
                    } # fin del diccionario de partidas
        print(len(partidas['FÁCIL']))
        nivelRandom = random.randrange(0, len(partidas['FÁCIL'])) # selecciona un nivel aleatorio
