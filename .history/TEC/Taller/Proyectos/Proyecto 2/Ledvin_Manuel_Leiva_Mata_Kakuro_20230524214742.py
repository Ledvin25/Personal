...
def play():
    ...
    def saveGame():
        ...
        # datos a guardar
        saved = [casillas_save, accionesPasadas_save, accionesFuturas_save, segundos['text'], minutos['text'], horas['text'], nivel_Casillas, elapsed_time]
        ...
        def continuarJuego():
            ...
            save.destroy()
            running = True
            actualizarCronometro(elapsed_time)
    ...
    def actualizarCronometro(start_time):
        ...
        if running:
            ...
            segundos.after(1000, actualizarCronometro, start_time=elapsed_time)
