...
def settings():
    ...
    def clock():
        ...
        match clockVar:
            ...
            case 2:
                clockbtn.configure(text="Tiempo limite")
    ...
    clockbtn = tk.Button(settingsWindow, text="SELECCIONE", width=15, height=2, font=("Eras Demi ITC", 12), background='#FF0066', command=tiempoLimite)
