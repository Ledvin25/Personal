...
def settings():
    ...
    # tamaño de la ventana 500x600 en el centro
    settingsWindow.geometry(f"500x600+{settingsWindow.winfo_screenwidth()//2-150}+{settingsWindow.winfo_screenheight()//2-100}")
